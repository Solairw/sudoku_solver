...
class SudokuBoard:
    ...
    def update_possible_vals(self):
        ...
        for sq in range(self.convert_to_square(), 9):
            ...
            if sq == self.convert_to_square():  # check if current square represents the current position of cursor
            ...
            for r in range(start_row, end_row):
                for c in range(start_col, end_col):
                    ...
                    # if not self.cells[r, c].possible_vals and not self.cells[r, c].solved:
                        ...
                        # print(self.cursor, self.cells[3, 2].val, self.cells[3, 2].possible_vals, self.cells[3, 2].tried_vals)
